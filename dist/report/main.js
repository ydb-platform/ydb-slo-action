...
function evaluateThreshold(comparison, config) {
  ...
  if (threshold) {
    if (threshold.critical_min !== void 0 && comparison.current.value < threshold.critical_min)
      import_core.debug(`${comparison.name}: below critical_min (${comparison.current.value} < ${threshold.critical_min})`), severity = "failure", reason = `Value ${comparison.current.value} < critical min ${threshold.critical_min}`;
    else if (threshold.critical_max !== void 0 && comparison.current.value > threshold.critical_max)
      import_core.debug(`${comparison.name}: above critical_max (${comparison.current.value} > ${threshold.critical_max})`), severity = "failure", reason = `Value ${comparison.current.value} > critical max ${threshold.critical_max}`;
    else if (threshold.warning_min !== void 0 && comparison.current.value < threshold.warning_min)
      import_core.debug(`${comparison.name}: below warning_min (${comparison.current.value} < ${threshold.warning_min})`), severity = "warning", reason = `Value ${comparison.current.value} < warning min ${threshold.warning_min}`;
    else if (threshold.warning_max !== void 0 && comparison.current.value > threshold.warning_max)
      import_core.debug(`${comparison.name}: above warning_max (${comparison.current.value} > ${threshold.warning_max})`), severity = "warning", reason = `Value ${comparison.current.value} > warning max ${threshold.warning_max}`;
  }
    ...
    if (comparison.change.direction === "worse") {
      if (severity !== "failure") {
        if (changePercent > criticalThreshold)
          severity = "failure", reason = `Regression ${changePercent.toFixed(1)}% > critical ${criticalThreshold}%`;
        else if (severity !== "warning" && changePercent > warningThreshold)
          severity = "warning", reason = `Regression ${changePercent.toFixed(1)}% > warning ${warningThreshold}%`;
      }
    }
  }
  return {
...
//# debugId=B9D76714265E6FBF64756E2164756E21
//# sourceMappingURL=data:application/json;base64,
