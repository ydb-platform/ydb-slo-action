...
var require_utils = __commonJS((exports) => {
  ...
  function getProxyFetch(destinationUrl) {
    ...
    return (url, opts) => __awaiter(this, void 0, void 0, function* () {
      return undici_1.fetch(url, Object.assign(Object.assign({}, opts), { dispatcher: httpDispatcher }));
    });
  }
...
var require_dist_node6 = __commonJS((exports, module) => {
  ...
  var import_universal_user_agent = require_dist_node(), VERSION = "9.0.5", userAgent = `octokit-endpoint.js/${VERSION} ${import_universal_user_agent.getUserAgent()}`, DEFAULTS = {
    method: "GET",
...
var require_dist_node7 = __commonJS((exports, module) => {
  ...
  module.exports = __toCommonJS(dist_src_exports);
  var import_deprecation = require_dist_node2(), import_once = __toESM(require_once()), logOnceCode = import_once.default((deprecation) => console.warn(deprecation)), logOnceHeaders = import_once.default((deprecation) => console.warn(deprecation)), RequestError = class extends Error {
...
var require_dist_node8 = __commonJS((exports, module) => {
  ...
  var request = withDefaults(import_endpoint.endpoint, {
    headers: {
      "user-agent": `octokit-request.js/${VERSION} ${import_universal_user_agent.getUserAgent()}`
    }
  });
});
...
var require_dist_node9 = __commonJS((exports, module) => {
  ...
  module.exports = __toCommonJS(dist_src_exports);
  var import_universal_user_agent = require_dist_node(), import_before_after_hook = require_before_after_hook(), import_request = require_dist_node8(), import_graphql = require_dist_node3(), import_auth_token = require_dist_node4(), VERSION = "5.2.0", noop = () => {
  }, consoleWarn = console.warn.bind(console), consoleError = console.error.bind(console), userAgentTrail = `octokit-core.js/${VERSION} ${import_universal_user_agent.getUserAgent()}`, Octokit = class {
    static {
    ...
    constructor(options = {}) {
      ...
      if (this.request = import_request.request.defaults(requestDefaults), this.graphql = import_graphql.withCustomRequest(this.request).defaults(requestDefaults), this.log = Object.assign({
        debug: noop,
        info: noop,
        warn: consoleWarn,
        error: consoleError
        ...
        if (!options.auth)
          ...
          let auth = import_auth_token.createTokenAuth(options.auth);
...
var require_github = __commonJS((exports) => {
  ...
  function getOctokit(token, options, ...additionalPlugins) {
    return new (utils_1.GitHub.plugin(...additionalPlugins))(utils_1.getOctokitOptions(token, options));
  }
